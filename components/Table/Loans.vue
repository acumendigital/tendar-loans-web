        ...
        <table>
          ...
          <tbody>
            <tr v-for="(data, index) in tableData" :key="index" class="table-row">
              ...
              <td class="td-4">
                <div class="td-content text-bold">{{ formatMoney(data.amount_borrowed, "NGN") }}</div>
              </td>
              <td class="td-3">
                <div class="td-content text-bold">
                  {{ formatMoney(data.amount_repaid, "NGN") }}
                </div>
              </td>
              <td class="td-4">
                <div class="td-content">{{ data.date_disbursed }}</div>
              </td>
              <td class="td-4">
                <div class="td-content">{{ data.repayment_date }}</div>
              </td>
              <td class="td-4">
